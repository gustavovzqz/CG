...
int main(int argc, char* argv[]){
    ...
    int nLin = 500;
                                  // Iambiente              / IPontual
    Luz luz = Luz(Ponto(0, -10, 0), Intensidade(0.1,0.1,0.1), Intensidade(0.7,0.7,0.7));
    Ponto cJanela = Ponto(0, 0, -dJanela);
    Ponto pObs = Ponto(0, 0, 0);
    Intensidade kd = Intensidade(0.7, 0.4, 0.4);
    Intensidade ke = Intensidade(0.7, 0.4, 0.4);
    Intensidade ka = Intensidade(0.7, 0.4, 0.4);
    ...
    Esfera esf3 = Esfera(Ponto(0, -10, -(dJanela + rEsfera)), rEsfera+2.5, Cor(255, 255, 255), ke, ke, ke, 10);
    Esfera boca = Esfera(Ponto(0, 7, -(dJanela + rEsfera)+6), 1, Cor(0, 0, 0), ke, ke, ke, 10);
    Esfera olho1 = Esfera(Ponto(2.5, 10, -(dJanela + rEsfera)+6), 1, Cor(0, 0, 0), ke, ke, ke, 10);
    Esfera olho2 = Esfera(Ponto(-2.5, 10, -(dJanela + rEsfera)+6), 1, Cor(0, 0, 0), ke, ke, ke, 10);
    Esfera botao1 = Esfera(Ponto(0, -6, -(dJanela + rEsfera)+10), 1, Cor(255, 0, 255), ke, ke, ke, 10);
    Esfera botao2 = Esfera(Ponto(0, -1, -(dJanela + rEsfera)+8), 1, Cor(255, 0, 255), ke, ke, ke, 10);
    Esfera botao3 = Esfera(Ponto(0, 3, -(dJanela + rEsfera)+8), 1, Cor(255, 0, 255), ke, ke, ke, 10);

    Canvas c = Canvas(nLin, nCol, Cor(0, 0, 0));
